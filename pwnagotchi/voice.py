...
class Voice:
    def __init__(self, lang):
        ...
        translation = gettext.translation(
            "voice", localedir, languages=[lang], fallback=True
        )
        translation.install()
    ...
    def on_ai_ready(self):
        return random.choice(
            [self._("AI ready."), self._("The neural network is ready.")]
        )

    def on_keys_generation(self):
        return random.choice([self._("Generating keys, do not turn off ...")])
    ...
    def on_free_channel(self, channel):
        return self._(
            "Hey, channel {channel} is free! Your AP will say thanks."
    ...
    def on_reading_logs(self, lines_so_far=0):
        if lines_so_far == 0:
            ...
            return self._("Read {lines_so_far} log lines so far ...").format(
                lines_so_far=lines_so_far
            )

    def on_bored(self):
        return random.choice([self._("I'm bored ..."), self._("Let's go for a walk!")])
    ...
    def on_angry(self):
        ...
        return random.choice(
            ["...", self._("Leave me alone ..."), self._("I'm mad at you!")]
        )
    ...
    def on_grateful(self):
        return random.choice(
            [self._("Good friends are a blessing!"), self._("I love my friends!")]
        )
    ...
    def on_shutdown(self):
        return random.choice([self._("Good night."), self._("Zzz")])
    ...
    def on_handshakes(self, new_shakes):
        ...
        return self._("Cool, we got {num} new handshake{plural}!").format(
            num=new_shakes, plural=s
        )

    def on_unread_messages(self, count, total):
        s = "s" if count > 1 else ""
        return self._("You have {count} new message{plural}!").format(
    ...
    def on_last_session_tweet(self, last_session):
        return self._(
            "I've been pwning for {duration} and kicked {deauthed} clients! I've also met {associated} new friends and ate {handshakes} handshakes! #pwnagotchi #pwnlog #pwnlife #hacktheplanet #skynet"
        ).format(
